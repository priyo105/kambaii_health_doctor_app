...
export default function writeNotesToPcp({navigation}){
    ...
    return(
        ...
        <View>
         <View style={{flexDirection:"row"}}>
              ...
              <Text style={{ textAlign:"center",backgroundColor:"blue",color:"white",fontWeight:"bold",marginTop:100,marginHorizontal:10}}>Write Notes to Pcp</Text>
            ...
            <View style={{flexDirection:"row",marginLeft:20,marginTop:20}}>
                    ...
                    <RoundedButton text="Next" color="green" onPress={()=>{console.warn("aaswdeda")}}></RoundedButton>
