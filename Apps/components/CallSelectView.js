...
export default function CallSelectView(props){
 ...
 return(
    ...
    <TouchableOpacity style={{marginLeft:30}} onPress={()=>{navigation.navigate("ZoomMeeting",{
        ...
        <Image style={{height:50,width:50,resizeMode:"contain",marginRight:10,marginLeft:40,marginTop:20}} source={require("../../assets/zoom.png")} />
         <Text style={{marginLeft:40,fontSize:14,color:"black",fontWeight:"bold"}}>Zoom Call</Text>
   </TouchableOpacity>
